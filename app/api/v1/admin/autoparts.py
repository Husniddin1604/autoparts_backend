...
router = APIRouter(
    prefix="/autoparts",
    tags=["admin-autoparts"],
)


# Brand endpoints (write operations)
...
# Part endpoints (write operations)
...
# PartNumbers endpoints (write operations)
...
# CrossReference endpoints (write operations)
...
# PartFitment endpoints (write operations)
